...
import io.dumb.objectivapinta.application.DumbApp;
import io.dumb.objectivapinta.application.domain.Authority;
import io.dumb.objectivapinta.application.domain.User;
import io.dumb.objectivapinta.application.repository.AuthorityRepository;
...
import io.dumb.objectivapinta.application.web.rest.errors.ExceptionTranslator;
import io.dumb.objectivapinta.application.web.rest.vm.KeyAndPasswordVM;
import io.dumb.objectivapinta.application.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = DumbApp.class)
